...
Elm.Main.make = function (_elm) {
   ...
   var middleText = function (f) {
      return $Graphics$Element.centered($Text.height(20)($Text.typeface(_L.fromArray(["futura"
                                                                                     ,"sans-serif"]))($Text.fromString(f))));
   };
   var body = function (f) {
      return $Graphics$Element.leftAligned($Text.typeface(_L.fromArray(["futura"
                                                                       ,"sans-serif"]))($Text.fromString(f)));
   };
   var subTitle = function (f) {
      return $Graphics$Element.leftAligned($Text.height(20)($Text.typeface(_L.fromArray(["futura"
                                                                                        ,"sans-serif"]))($Text.fromString(f))));
   };
   ...
   var title = function (f) {
      return $Graphics$Element.centered($Text.height(50)($Text.color(elmGreen)($Text.typeface(_L.fromArray(["futura"
                                                                                                           ,"sans-serif"]))($Text.fromString(f)))));
   };
   ...
   var codeText = function (f) {
      return $Graphics$Element.leftAligned($Text.color(elmBlue)($Text.typeface(_L.fromArray(["futura"
                                                                                            ,"sans-serif"]))($Text.fromString(f))));
   };
   ...
   var indent = 20;
   var hoveredOn = $Signal.mailbox("");
   var importColor = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      colorMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var importGraphicsElement = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      graphicsElementMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var importGraphicsCollage = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      graphicsCollageMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalMain1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalMain1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("main ="));
   var signalMain2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalMain2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalGameState1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalGameState1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalGameState2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalGameState2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("gameState ="));
   var signalGameState3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalGameState3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalDelta1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalDelta1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("delta ="));
   var signalDelta2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalDelta2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalInput1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalInput2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("input ="));
   var signalInput3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalInput4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalInput5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalInput6 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput6Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalInput7 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput7Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var signalInput8 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      signalInput8Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("      delta"));
   ...
   var playingSize = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      playingSizeMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var typeState = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      typeStateMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var aliasBadGuy1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasBadGuy1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var aliasBadGuy2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasBadGuy2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var aliasPlayer1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasPlayer1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var aliasPlayer2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasPlayer2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var aliasGame1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasGame1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var aliasGame2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasGame2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var defaultGame1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      defaultGame1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var defaultGame2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      defaultGame2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var defaultGame3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      defaultGame3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var defaultGame4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      defaultGame4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var defaultGame5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      defaultGame5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var defaultGame7 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      defaultGame7Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  }"));
   ...
   var aliasInput1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasInput1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var aliasInput2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasInput2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  { space : Bool"));
   var aliasInput3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasInput3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  , dir1 : Int"));
   var aliasInput4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasInput4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  , dir2 : Int"));
   var aliasInput5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasInput5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  , delta : Time"));
   var aliasInput6 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      aliasInput6Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  }"));
   ...
   var updateFunc1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    newState ="));
   var updateFunc6 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc6Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc7 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc7Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc8 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc8Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc9 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc9Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    newBadGuy ="));
   var updateFunc10 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc10Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc11 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc11Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc12 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc12Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc13 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc13Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  in"));
   var updateFunc14 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc14Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    { game |"));
   var updateFunc15 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc15Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc16 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc16Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc17 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc17Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateFunc18 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateFunc18Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    }"));
   ...
   var updateBadGuy1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("       { badGuy |"));
   var updateBadGuy6 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy6Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy7 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy7Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy8 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy8Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("       }"));
   ...
   var updateBadGuy9 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy9Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy10 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy10Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("       { badGuy |"));
   var updateBadGuy11 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy11Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy12 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy12Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateBadGuy13 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateBadGuy13Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("       }"));
   ...
   var updatePlayer1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer6 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer6Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("      then 0"));
   var updatePlayer7 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer7Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer8 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer8Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  in"));
   var updatePlayer9 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer9Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    { player1 |"));
   var updatePlayer10 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer10Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer11 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer11Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer12 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer12Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePlayer13 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePlayer13Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    }"));
   ...
   var updatePhysics1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePhysics1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updatePhysics2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePhysics2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  { obj |"));
   var updatePhysics3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePhysics3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    x <- x + vx * t,"));
   var updatePhysics4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePhysics4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("    y <- y + vy * t"));
   var updatePhysics5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updatePhysics5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  }"));
   ...
   var updateNear1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateNear1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("near k c n ="));
   var updateNear2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateNear2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateWithin1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateWithin1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateWithin2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateWithin2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateStepV1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateStepV1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateStepV2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateStepV2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateStepV3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateStepV3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var updateStepV4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      updateStepV4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc1 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc1Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc2 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc2Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc3 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc3Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc4 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc4Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc5 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc5Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("  in"));
   var viewFunc6 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc6Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc7 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc7Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc8 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc8Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc9 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc9Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc10 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc10Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("      , ngon 6 25 "));
   var viewFunc11 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc11Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc12 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc12Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc13 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc13Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("      , circle 20"));
   var viewFunc14 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc14Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc15 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc15Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc16 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc16Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc17 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc17Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc18 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc18Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc19 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc19Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var viewFunc20 = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      viewFunc20Msg) : A2($Signal.message,
      hoveredOn.address,
      "");
   })(codeText("      ]"));
   ...
   var elmGreyColor = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      elmGreyColorMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var elmBlueColor = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      elmBlueColorMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var elmGreenColor = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      elmGreenColorMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
   ...
   var textColor = $Graphics$Input.hoverable(function (r) {
      return r ? A2($Signal.message,
      hoveredOn.address,
      textColorMsg) : A2($Signal.message,
      hoveredOn.address,
      "");
